...
int Geography::init(uint iNumCells, uint iMaxNeighbors, geonumber dRadius, geonumber dSeaLevel) {
    ...
    memset(m_adLatitude,  0, m_iNumCells*sizeof(double));
    memset(m_adLatitude,  0, m_iNumCells*sizeof(double));
    memset(m_adAltitude,  0, m_iNumCells*sizeof(double));
    memset(m_adDistances, 0, m_iNumCells*sizeof(double));
    memset(m_adArea,      0, m_iNumCells*sizeof(double));
