...
public:
    ...
    virtual int writeStatArrsQDF(hid_t hSpeciesGroup)=0;
    virtual int readStatArrsQDF(hid_t hSpeciesGroup)=0;
    ...
    virtual int modifyParams(const std::string sAttrName, double dValue)=0;
