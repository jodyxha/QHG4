...
public:
    ...
    int addAgent(int iCellIndex, char *pData, bool bUpdateCount);
    ...
    void setAgentBasic(int iAgentIndex, void *pBasic);

    virtual int mergePop(PopBase *pPop);
    int shiftIDs(idtype iOffset);
    ...
    ulong getNumAgents(int iCellIndex) { return m_aiNumAgentsPerCell[iCellIndex];};
    ...
    void setAgentDataType();
    //void showStates(bool bFull);
    virtual void setQDFVersionIn(int iV) {m_iQDFVersionIn = iV;};
    virtual int  getQDFVersionIn() {return m_iQDFVersionIn;};
    virtual void setQDFVersionOut(int iV) {m_iQDFVersionOut = iV;};
    virtual int  getQDFVersionOut() {return m_iQDFVersionOut;};
protected:
    int m_iNumCells;
    ulong m_iTotal;
    ulong m_iNumBirths;
    ...
    virtual int makePopSpeficiMove(int iCellIndexFrom, int iAgentIndex, int iCellIndexTo) { return 0; };
    ...
    int dumpStatArrsQDF(hid_t hSpeciesGroup);
    int restoreStatArrsQDF(hid_t hSpeciesGroup);
