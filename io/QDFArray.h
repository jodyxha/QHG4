...
public:
    ...
    int getFirstSlab(int *pBuffer, int iSize, const std::string sFieldName="");
    int getFirstSlab(long *pBuffer, int iSize, const std::string sFieldName="");
    int getFirstSlab(ulong *pBuffer, int iSize, const std::string sFieldName="");
    int getFirstSlab(double *pBuffer, int iSize, const std::string sFieldName="");
...
protected:
    ...
    template<typename T>
    int getFirstSlab(T *pBuffer, int iSize, hid_t hBaseType, const std::string sFieldName);
