...
// getFirstSlab
//
int QDFArray::getFirstSlab(int *pBuffer, int iSize, const std::string sFieldName) {
    int iResult = -1;
...
// getFirstSlab
//
int QDFArray::getFirstSlab(double *pBuffer, int iSize, const std::string sFieldName) {
    int iResult = -1;
...
// getFirstSlab
//
int QDFArray::getFirstSlab(long *pBuffer, int iSize, const std::string sFieldName) {
    int iResult = -1;
...
// getFirstSlab
//
int QDFArray::getFirstSlab(ulong *pBuffer, int iSize, const std::string sFieldName) {
    int iResult = -1;
...
//
template<typename T>
int QDFArray::getFirstSlab(T *pBuffer, int iSize, hid_t hBaseType, const std::string sFieldName) {
    int iResult = -1;
...
// setDataType
//
int QDFArray::setDataType(const std::string sFieldName, hid_t hBaseType, int iSize) {
    int iResult = -1;
