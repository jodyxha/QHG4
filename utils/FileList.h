...
typedef std::map<std::string, stringvec *> MAP_STRING_LIST;
...
public:
    ...
    *** ***************************************************************************/
    ...
    /** ***************************************************************************\
    *   \fn     int replaceRefs(stringvec &vs, char *pOut, char *pOutR)
    ...
    *           the vector vs.
    *** ***************************************************************************/
    static int replaceRefs(VEC_INTS &vOrder, stringvec &vs, const char *pOut, char *pOutR);

    /** ***************************************************************************\
    *   \fn     int replaceRefsSimple(stringvec &vs, char *pOut, char *pOutR)
    ...
    *** ***************************************************************************/
    static int replaceRefsSimple(stringvec &vs, const char *pOut, char *pOutR);
