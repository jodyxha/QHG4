...
public:
    ...
    static const uchar PASSIVE = 0;
    static const uchar ACTIVE  = 1;

    static const int DUMP_MODE_NONE  = -1;
    static const int DUMP_MODE_FLAT  =  0;
    static const int DUMP_MODE_SMART =  1;
    static const int DUMP_MODE_FREE  =  2;
