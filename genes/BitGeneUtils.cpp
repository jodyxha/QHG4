...
//
void BitGeneUtils::freeReco(ulong *pGenome1, ulong *pGenome2, int iNumBlocks, WELL512* pWELL) {
...
// fillConstValues
//
ulong *BitGeneUtils::fillConstValues(int iNumParents, int iGenomeSize, ulong iValue) {
    int iNumBlocks = numNucs2Blocks(iGenomeSize);
