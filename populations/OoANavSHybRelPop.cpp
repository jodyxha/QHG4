...
OoANavSHybRelPop::OoANavSHybRelPop(SCellGrid *pCG, PopFinder *pPopFinder, int iLayerSize, IDGen **apIDG, uint32_t *aulState, uint *aiSeeds) 
    ...
    SingleEvaluator<OoANavSHybRelAgent> *pSEAlt = new SingleEvaluator<OoANavSHybRelAgent>(this, pCG, "Alt", NULL, (double*)m_pCG->m_pGeography->m_adAltitude, "AltCapPref", false, sTriggerIDs);
    ...
    //    m_pCM = new ConfinedMove<OoANavSHybRelAgent>(this, m_pCG, "", this->m_vMoveList);
