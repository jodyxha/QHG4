...
OoANavRelCompRPop::OoANavRelCompRPop(SCellGrid *pCG, PopFinder *pPopFinder, int iLayerSize, IDGen **apIDG, uint32_t *aulState, uint *aiSeeds) 
    ...
    // m_adCapacities belongs to SPopulation
    ...
    // oriSingleEvaluator<OoANavRelCompRAgent> *pSEAlt = new SingleEvaluator<OoANavRelCompRAgent>(this, pCG, NULL, (double*)m_pCG->m_pGeography->m_adAltitude, "AltCapPref", true, EVENT_ID_GEO);
    SingleEvaluator<OoANavRelCompRAgent> *pSEAlt = new SingleEvaluator<OoANavRelCompRAgent>(this, m_pCG, "Alt", NULL, (double*)m_pCG->m_pGeography->m_adAltitude, "AltCapPref", false, sTriggerIDs);
    // for mult: SingleEvaluator<OoANavRelCompRAgent> *pSEAlt = new SingleEvaluator<OoANavRelCompRAgent>(this, pCG, "Alt", NULL, (double*)m_pCG->m_pGeography->m_adAltitude, "AltCapPref", false, EVENT_ID_GEO);
    ...
    //    m_pCM = new ConfinedMove<OoANavRelCompRAgent>(this, m_pCG, "", this->m_vMoveList);
