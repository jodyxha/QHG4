...
PersOoANavSHybRelPop::PersOoANavSHybRelPop(SCellGrid *pCG, PopFinder *pPopFinder, int iLayerSize, IDGen **apIDG, uint32_t *aulState, uint *aiSeeds) 
    ...
    SingleEvaluator<PersOoANavSHybRelAgent> *pSEAlt = new SingleEvaluator<PersOoANavSHybRelAgent>(this, pCG, "Alt", NULL, (double*)m_pCG->m_pGeography->m_adAltitude, "AltCapPref", false, sTriggerIDs);
    ...
    //    m_pCM = new ConfinedMove<PersOoANavSHybRelAgent>(this, m_pCG, "", this->m_vMoveList);
