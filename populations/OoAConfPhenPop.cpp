...
OoAConfPhenPop::OoAConfPhenPop(SCellGrid *pCG, PopFinder *pPopFinder, int iLayerSize, IDGen **apIDG, uint32_t *aulState, uint *aiSeeds) 
    ...
    SingleEvaluator<OoAConfPhenAgent> *pSEAlt = new SingleEvaluator<OoAConfPhenAgent>(this, m_pCG, "Alt", NULL, (double*)m_pCG->m_pGeography->m_adAltitude, "AltCapPref", true, EVENT_ID_GEO);
    ...
    m_pCM = new ConfinedMove<OoAConfPhenAgent>(this, m_pCG, "", this->m_vMoveList);
