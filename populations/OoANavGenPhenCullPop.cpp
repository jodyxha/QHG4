...
OoANavGenPhenCullPop::OoANavGenPhenCullPop(SCellGrid *pCG, PopFinder *pPopFinder, int iLayerSize, IDGen **apIDG, uint32_t *aulState, uint *aiSeeds) 
    ...
    SingleEvaluator<OoANavGenPhenCullAgent> *pSEAlt = new SingleEvaluator<OoANavGenPhenCullAgent>(this, m_pCG, "Alt", NULL, (double*)m_pCG->m_pGeography->m_adAltitude, "AltCapPref", true, EVENT_ID_GEO);
    ...
    //    m_pCM = new ConfinedMove<OoANavGenPhenCullAgent>(this, m_pCG, "", this->m_vMoveList);
