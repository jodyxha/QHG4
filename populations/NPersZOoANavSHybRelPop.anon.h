...
public:
    NPersXOoANavSHybRelPop(SCellGrid *pCG, PopFinder *pPopFinder, int iLayerSize, IDGen **apIDG, uint32_t *aulState, uint *aiSeeds);
 ...
 protected:
    ...
    double m_dParentContribAvg;
    double m_dParentContribSDev;
};
