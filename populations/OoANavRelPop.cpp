...
OoANavRelPop::OoANavRelPop(SCellGrid *pCG, PopFinder *pPopFinder, int iLayerSize, IDGen **apIDG, uint32_t *aulState, uint *aiSeeds) 
    ...
    // ori SingleEvaluator<OoANavRelAgent> *pSEAlt = new SingleEvaluator<OoANavRelAgent>(this, m_pCG, "Alt", NULL, (double*)m_pCG->m_pGeography->m_adAltitude, "AltCapPref", true, EVENT_ID_GEO);
    SingleEvaluator<OoANavRelAgent> *pSEAlt = new SingleEvaluator<OoANavRelAgent>(this, m_pCG, "Alt", NULL, (double*)m_pCG->m_pGeography->m_adAltitude, "AltCapPref", false, EVENT_ID_GEO);
    ...
    //    m_pCM = new ConfinedMove<OoANavRelAgent>(this, m_pCG, "", this->m_vMoveList);
