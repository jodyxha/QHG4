...
const int SPECIAL_NEGINF = 0;
const int SPECIAL_SUBMIN = 1;
const int SPECIAL_SUPMAX = 2;
const int SPECIAL_POSINF = 3;
const int SPECIAL_NANVAL = 4;
const int NUM_SPECIALS   = 5;
