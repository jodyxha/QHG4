...
// format accepted
//
bool GeneWriter2::formatAccepted(const std::string sFormat) {
...
//
int GeneWriter2::writeSequence(const std::string sFormat, SequenceProvider<ulong> *pGP, const std::string sOutputFile,  const loc_data &mLocData,  const IDSample *pSample, bool bFull, bool bHeaders, bool bBitNucs) {
    int iResult = 0;
...
//
int GeneWriter2::writeGenesPlink(SequenceProvider<ulong> *pGP, const std::string sOutputFile,  const loc_data &mLocDefs,  const IDSample *pSample) {
    int iResult = -1;
    ...
    if (fOut != NULL) {
        ...
        stringvec vParts;
        splitString(sOutputFile, vParts, "."); // ignore return value
        std::string sOutMap = vParts[0] + ".map";
        /*
...
//
int GeneWriter2::writeGenesBin(SequenceProvider<ulong> *pGP, const std::string sOutputFile, const loc_data &mLocDefs,  const IDSample *pSample, bool bFull, bool bBitNucs) {
    int iResult = 0;
...
//    GeneLat       : double    // latitude of genome
//
int GeneWriter2::writeGenesAsc(SequenceProvider<ulong> *pGP, const std::string sOutputFile,  const loc_data &mLocDefs,   const IDSample *pSample, bool bFull, bool bHeaders, bool bBitNucs) {
    int iResult = -1;
...
//    0=A, 1=C, 2=G, 3=T
//
int GeneWriter2::writeGenesNum(SequenceProvider<ulong> *pGP, const std::string sOutputFile,   const IDSample *pSample, bool bAddID, bool bBitNucs) {
    int iResult = -1;
