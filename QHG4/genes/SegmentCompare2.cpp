...
#include <cvtkSmartPointer>
#include <cvtkPolyData>
#include <cvtkPolyDataWriter>
#include <cvtkPointData>
#include <cvtkDoubleArray>
#include <cvtkDataArray>
...
char *getPopName(const char *sQHGPop, const char *sPopName) {
    ...
    if (sPopName == NULL) {
        ...
        sPopName = qdf_getFirstPopulation(sQHGPop);
       
    } else {
        printf("Checking popname for [%s]\n", sQHGPop);
        sPopName = qdf_checkForPop(sQHGPop, sPopName);
    }
