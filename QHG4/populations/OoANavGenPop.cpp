...
OoANavGenPop::OoANavGenPop(SCellGrid *pCG, PopFinder *pPopFinder, int iLayerSize, IDGen **apIDG, uint32_t *aulState, uint *aiSeeds) 
    ...
    SingleEvaluator<OoANavGenAgent> *pSEAlt = new SingleEvaluator<OoANavGenAgent>(this, m_pCG, "Alt", NULL, (double*)m_pGeography->m_adAltitude, "AltCapPref", true, EVENT_ID_GEO);
