...
OoANavRelRPop::OoANavRelRPop(SCellGrid *pCG, PopFinder *pPopFinder, int iLayerSize, IDGen **apIDG, uint32_t *aulState, uint *aiSeeds) 
    ...
    // ori SingleEvaluator<OoANavRelRAgent> *pSEAlt = new SingleEvaluator<OoANavRelRAgent>(this, m_pCG, "Alt", NULL, (double*)m_pGeography->m_adAltitude, "AltCapPref", true, EVENT_ID_GEO);
    SingleEvaluator<OoANavRelRAgent> *pSEAlt = new SingleEvaluator<OoANavRelRAgent>(this, m_pCG, "Alt", NULL, (double*)m_pGeography->m_adAltitude, "AltCapPref", false, EVENT_ID_GEO);
