...
OoANavRelCompPop::OoANavRelCompPop(SCellGrid *pCG, PopFinder *pPopFinder, int iLayerSize, IDGen **apIDG, uint32_t *aulState, uint *aiSeeds) 
    ...
    // oriSingleEvaluator<OoANavRelCompAgent> *pSEAlt = new SingleEvaluator<OoANavRelCompAgent>(this, pCG, NULL, (double*)m_pGeography->m_adAltitude, "AltCapPref", true, EVENT_ID_GEO);
    SingleEvaluator<OoANavRelCompAgent> *pSEAlt = new SingleEvaluator<OoANavRelCompAgent>(this, m_pCG, "Alt", NULL, (double*)m_pGeography->m_adAltitude, "AltCapPref", false, sTriggerIDs);
    // for mult: SingleEvaluator<OoANavRelCompAgent> *pSEAlt = new SingleEvaluator<OoANavRelCompAgent>(this, pCG, "Alt", NULL, (double*)m_pGeography->m_adAltitude, "AltCapPref", false, EVENT_ID_GEO);
