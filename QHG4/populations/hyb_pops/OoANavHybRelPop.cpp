...
OoANavHybRelPop::OoANavHybRelPop(SCellGrid *pCG, PopFinder *pPopFinder, int iLayerSize, IDGen **apIDG, uint32_t *aulState, uint *aiSeeds) 
    ...
    SingleEvaluator<OoANavHybRelAgent> *pSEAlt = new SingleEvaluator<OoANavHybRelAgent>(this, pCG, "Alt", NULL, (double*)m_pGeography->m_adAltitude, "AltCapPref", false, sTriggerIDs);
