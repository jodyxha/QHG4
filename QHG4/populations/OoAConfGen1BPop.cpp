...
OoAConfGen1BPop::OoAConfGen1BPop(SCellGrid *pCG, PopFinder *pPopFinder, int iLayerSize, IDGen **apIDG, uint32_t *aulState, uint *aiSeeds) 
    ...
    SingleEvaluator<OoAConfGen1BAgent> *pSEAlt = new SingleEvaluator<OoAConfGen1BAgent>(this, m_pCG, "Alt", NULL, (double*)m_pGeography->m_adAltitude, "AltCapPref",true, EVENT_ID_GEO);
