...
OoANavGen2bitAssPop::OoANavGen2bitAssPop(SCellGrid *pCG, PopFinder *pPopFinder, int iLayerSize, IDGen **apIDG, uint32_t *aulState, uint *aiSeeds) 
    ...
    SingleEvaluator<OoANavGen2bitAssAgent> *pSEAlt = new SingleEvaluator<OoANavGen2bitAssAgent>(this, pCG, "Alt", NULL, (double*)m_pGeography->m_adAltitude, "AltCapPref", true, EVENT_ID_GEO);
