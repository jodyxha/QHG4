...
| LineReader
| 
|  Base class for utilities to read lines from a file
|  - createInstance() will open the file for reading, or return NULL on error
...
public:
    static LineReader *createInstance(const std::string sName, const std::string sMode, int iLineLen=MAX_LINE2);
    static LineReader *createInstance(FILE *fIn, int iLineLen=MAX_LINE2);
    LineReader_std(const std::string sName, const std::string sMode, int iLineLen=MAX_LINE2);
...
public:
    ...
    LineReader_gz(const std::string sName, const std::string sMode, int iLineLen=MAX_LINE2);
