...
|    distance (spheric, cartesian. cartesian withperodicity
|
...
double cartdistPeri(int iX1, int iY1, int iX2, int iY2, 
                    int iW, int iH, bool bPeriodicX, bool bPeriodicY, double dScale);
