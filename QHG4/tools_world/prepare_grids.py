...
if ('QHG_DIR') in os.environ:
  ...
  QHG3_BASE    =  os.environ['HOME']+"/progs/multi_spc_QHG3_std/"
#-- end if
...
gridfix_pat = CORE_DATA+"/gridfixes2_darda_###.dat"
...
# npp stuff
npp_file1        = CORE_DATA+"/npp_timmermann.nc"
npp_file2       = CORE_DATA+"/NPPDO0.nc"
LON_NAME1  = 'XAXLEVITR'
LAT_NAME1  = 'YAXLEVITR'
TIME_NAME1 = 'TAXI'
NPP_NAME1  = 'NPPHRS'
...
# navigation
# 'bridges' between indonesian islands and australia
SEAWAY_DIST = "200"
SEAWAY_BOX  = "103:-11:130:8,120:-15:154:0"
# 'bridge' for bab el mandab
#SEAWAY_DIST = "150"
#SEAWAY_BOX  = "43.0:12.6:43.8:12.8"
bridge_pat  = CORE_DATA+"/bridges_###.dat"
...
def doWork(grid_level, tMin, tMax, deltaT, output_prefix, sealevels, bSkipInitial):
    ...
    bridge_file = bridge_pat.replace("###", str(grid_level))
    ...
    if iResult == 0:
        ...
        npp_int  = ni.NPPInterpolator(npp_file1, LON_NAME1, LAT_NAME1, TIME_NAME1, NPP_NAME1)
    ...
    if iResult == 0:
        ...
        while (t > tMin) and (iResult == 0):
            qdf_name=output_pat.replace("###", "%05.1f"%(t))
