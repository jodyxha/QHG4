...
// write
//
int IcoGridNodes::write(const std::string sOutput, int iMaxLinks, bool bAddTilingInfo, stringmap &mAdditionalHeaderLines) {
    int iResult = -1;
...
// read
//
int IcoGridNodes::read(const std::string sInput) {
    int iResult = -1;
    int iMaxLinks = -1;
    bool bAddTilingInfo = false;
    bool bVer2 = true;
