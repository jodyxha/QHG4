...
#pragma omp parallel
            ...
            m_pSeqIO = SequenceIOUtils<float>::createInstance(PHENOME_DATASET_NAME.c_str(), H5T_NATIVE_FLOAT, &m_aPhenome, m_pAgentController, m_pvDeadList, m_iTotalSize/*m_iPhenomeSize*/);
