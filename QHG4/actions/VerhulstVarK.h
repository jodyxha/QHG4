...
const static std::string ATTR_VERHULSTVARK_B0_NAME   = "Verhulst_b0";
const static std::string ATTR_VERHULSTVARK_D0_NAME   = "Verhulst_d0";
const static std::string ATTR_VERHULSTVARK_TURNOVER_NAME   = "Verhulst_theta";
